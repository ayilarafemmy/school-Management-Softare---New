<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="admin_students.aspx.cs" Inherits="admin_students" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Student-all">All Students</a></li>
                        <li class="nav-item"><a href="admin_students_all.aspx">Add Students</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Student ID." CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <div class="input-group">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Class" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="TextBox4" runat="server" placeholder="Gender" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6">
...
<%--          <asp:HyperLinkField HeaderText="Test Icon" DataNavigateUrlFields="PID" DataNavigateUrlFormatString="~/ClientInfo.aspx?PID={0}" DataTextField="clientComments" DataTextFormatString= "<img src='~/che.fw.png' alt='More Info'"/>"/>--%>
       <asp:HyperLinkField HeaderText="" DataNavigateUrlFields="SID" DataNavigateUrlFormatString="~/admin_student_info.aspx?SID={0}" DataTextField="SID" DataTextFormatString= "<img src='che.fw.png' alt='More Info'/>"/>
