<%@ Page Title="" Language="C#" MasterPageFile="~/Parent_MasterPage.master" AutoEventWireup="true" CodeFile="parents_students.aspx.cs" Inherits="admin_students" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        ...
                        <li class="nav-item"><a href="parents_students_all.aspx">Add Student</a></li>
   ...
   <Columns>
                                                        ...
                                                        <asp:ImageField DataImageUrlField="Photo" HeaderText="Image" ItemStyle-Width="15px" ItemStyle-Height="15px"></asp:ImageField>  
