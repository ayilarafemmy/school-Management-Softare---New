<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="admin_parent_info.aspx.cs" Inherits="admin_students" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Student-add">Parent Information</a></li>
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Basic Information - <asp:Label ID="Label7" runat="server" Text="*"></asp:Label></h3> 
