...
public partial class Teacher_Students : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("teacher_login.aspx?url=" + Server.UrlEncode(Request.Url.AbsoluteUri));
        }
    ...
    protected void BindGrid4()
    {
        ...
        {
            con.Open();
            string com = "select distinct ClassID, FClass as Class from D_Classes";
            ...
            DropDownList4.DataBind();
            DropDownList4.Items.Insert(0, new System.Web.UI.WebControls.ListItem("Select Class", "0"));
            con.Close();
        }
    }
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                pdfDoc.Close();
                Response.ContentType = "application/pdf";
                Response.AddHeader("content-disposition", "attachment;filename=Students_" + DropDownList4.SelectedItem.Text + DateTime.Now.ToString("ddMMyy_hhmm") + ".pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
                Response.Write(pdfDoc);
                Response.End();
            }
    ...
    {
        string q = "select a.Date,a.Term,b.Subject,c.Time,CONCAT(d.FirstName,' ',d.LastName) as Invigilatot  from D_Exams a, D_Subjects b, D_ExamPeriod c,D_Staff d where a.Subject = b.SubjectID and a.Time = c.ETID and d.StaffID = a.Invigilator and a.Status='Future'  and a.ClassID='" + DropDownList4.SelectedValue + "'";
        string n = "Exams_" + DropDownList4.SelectedItem.Text + DateTime.Now.ToString("ddMMyyhhmm");
        export(q, n);
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //search and populate
        string jj = "select a.SID,concat(a.FirstName,' ',a.LastName) as Name,CONCAT('~/Students/',a.Photo,a.filetype) as Photo,b.Fclass as Class,a.Gender,a.Balance,a.Status from D_Students a, D_Classes b where and a.Parent_ID='" + Session["PID"].ToString() + "' and a.Class = b.ClassID and a.SID='" + TextBox1.Text + "' OR a.FirstName like '%" + TextBox2.Text + "%' OR a.LastName like '%" + TextBox2.Text + "%' OR b.Fclass like '%" + TextBox3.Text + "%' OR a.Gender='" + TextBox4.Text + "'";
        BindGridMethod(jj);
        if (GridView1.Rows.Count < 1)
        {
            ...
            meta.Content = "0;url=  parents_students.aspx";
    ...
    protected void DropDownList4_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            //select and Bind to grid
            string query = "select a.EID,a.Date,a.Term,b.Subject,c.Time,CONCAT(d.FirstName,' ',d.LastName) as Invigilatot   from D_Exams a, D_Subjects b, D_ExamPeriod c,D_Staff d where a.Subject = b.SubjectID and a.Time = c.ETID and d.StaffID = a.Invigilator and a.Status='Future'  and a.ClassID='" + DropDownList4.SelectedValue + "' order by a.Date desc";
            BindGridMethod(query);
            //if doesn't exist, show message and return
            if (GridView1.Rows.Count < 1)
            {
                MessageBox("No Exam Found");
                GridView1.Visible = false;
                LinkButton1.Visible = false;
                LinkButton2.Visible = false;
                return;
