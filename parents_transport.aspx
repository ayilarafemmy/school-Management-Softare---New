<%@ Page Title="" Language="C#" MasterPageFile="~/Parent_MasterPage.master" AutoEventWireup="true" CodeFile="parents_transport.aspx.cs" Inherits="Parents_Message" %>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Primary-tab" data-toggle="tab" href="#Primary"> Transport Information</a></li>
            ...
            <div class="container-fluid">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="Primary">
                        <asp:GridView ID="GridView1" runat="server" DataKeyNames="Examaccesscode" CssClass="table table-striped mb-0 " AllowPaging="true" EmptyDataText="No Data." AutoGenerateColumns="false">
                            <Columns>
