<%@ Page Title="" Language="C#" MasterPageFile="~/Parent_MasterPage.master" AutoEventWireup="true" CodeFile="parents-compose.aspx.cs" Inherits="Parents_Message" %>
            ...
            <div class="container-fluid">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="Primary">
                        <div>
                            <asp:Label ID="Label2" runat="server" Text="*" Visible="false"></asp:Label><asp:Label ID="Label3" runat="server" Text="*" Visible="false"></asp:Label>
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList> <br /><br />
...
<ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" DataKeyNames="RelationshipID" CssClass="table table-striped mb-0 " AllowPaging="true" EmptyDataText="No Message Received Yet." AutoGenerateColumns="false" Visible="false">
                            <Columns>
