...
<div id="main_content">
    ...
    <div class="user_div">
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#righttab-statistics">Financials & Other Data</a></li>
            ...
            <div class="tab-pane fade show active" id="righttab-statistics" role="tabpanel">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="py-3 m-0 text-center h1 text-success">N<asp:Label ID="Label1" runat="server" Text="*"></asp:Label></div>
                        <div class="d-flex">
                            <span class="text-muted">Income</span>
                            <div class="ml-auto"><i class="fa fa-caret-up text-success"></i></div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <ul class="list-unstyled mb-0">
                            <li class="mb-3">
                                <div class="clearfix">
                                    <div class="float-left"><strong>N <asp:Label ID="Label3" runat="server" Text="*"></asp:Label></strong></div>
                                    <div class="float-right"><small class="text-muted">Inflow this month</small></div>
                                </div>
                                <div class="progress progress-xxs">
                                    <div class="progress-bar bg-azure" role="progressbar" style="width: 80%" aria-valuenow="42" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </li>
                            <li>
                                <div class="clearfix">
                                    <div class="float-left"><strong>N <asp:Label ID="Label4" runat="server" Text="*"></asp:Label></strong></div>
                                    <div class="float-right"><small class="text-muted">Outflow this month</small></div>
                                </div>
                                <div class="progress progress-xxs">
