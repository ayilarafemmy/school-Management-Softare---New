    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
{
    ...
    {
        string q = "select a.SID,concat(a.FirstName,' ',a.LastName) as Name,b.Fclass as Class,a.Gender,a.Balance,a.Status from D_Students a, D_Classes b where a.Class = b.ClassID and a.Parent_ID='"+Session["PID"].ToString()+"'";
