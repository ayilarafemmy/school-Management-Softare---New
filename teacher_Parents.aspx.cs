...
public partial class Teacher_Students : System.Web.UI.Page
{
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
            using (HtmlTextWriter hw = new HtmlTextWriter(sw))
            {
                ...
                pdfDoc.Close();
                Response.ContentType = "application/pdf";
                Response.AddHeader("content-disposition", "attachment;filename=Parents_" + DropDownList4.SelectedItem.Text + DateTime.Now.ToString("ddMMyy_hhmm") + ".pdf");
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
                Response.Write(pdfDoc);
                Response.End();
            }
    ...
    {
        string q = "select distinct PID,CONCAT(a.First_Name,' ',a.Last_Name) as Name,a.Relationship,a.Email,a.Phone, a.Full_Address,a.Status  FROM D_Parents a, D_Students b, D_Classes c  where a.Status !='R' and a.PID=b.Parent_ID and b.Class = c.ClassID and c.ClassID='" + DropDownList4.SelectedValue + "'";
    ...
    protected void DropDownList4_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string query = "select distinct a.PID,concat('~/Parents/',a.Identity_Upload,a.filetype) as photo,CONCAT(a.First_Name,' ',a.Last_Name) as Name,a.Relationship,a.Email,a.Phone, a.Full_Address,a.Status  FROM D_Parents a, D_Students b, D_Classes c  where a.Status !='R' and a.PID=b.Parent_ID and b.Class = c.ClassID and c.ClassID='" + DropDownList4.SelectedValue + "'";
            BindGridMethod(query);
            //if doesn't exist, show message and return
            if (GridView1.Rows.Count < 1)
            {
                MessageBox("No Parent Found");
                GridView1.Visible = false;
                LinkButton1.Visible = false;
                LinkButton2.Visible = false;
                return;
