<%@ Page Title="" Language="C#" MasterPageFile="~/Parent_MasterPage.master" AutoEventWireup="true" CodeFile="parents_Academics.aspx.cs" Inherits="admin_students" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Student-all">Subjects</a></li>
   ...
   <Columns>
       ...
       <asp:BoundField DataField="Type" HeaderText="Type"
            SortExpression="Type" />
<%--          <asp:HyperLinkField HeaderText="Test Icon" DataNavigateUrlFields="PID" DataNavigateUrlFormatString="~/ClientInfo.aspx?PID={0}" DataTextField="clientComments" DataTextFormatString= "<img src='~/che.fw.png' alt='More Info'"/>"/>--%>
     <%--  <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="SID" DataNavigateUrlFormatString="~/parents_student_info.aspx?SID={0}" DataTextField="SID" DataTextFormatString= "<img src='vi.fw.png' alt=''/>"/>
     --%>    <%--<asp:CommandField ButtonType="Image" DeleteImageUrl="ch.fw.png" ShowDeleteButton="True" />--%>
          </Columns>
</asp:GridView>
                        </div>
                    </div>
