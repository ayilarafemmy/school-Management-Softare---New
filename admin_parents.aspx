<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="admin_parents.aspx.cs" Inherits="admin_students" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Student-all">All Parents</a></li>
                        <li class="nav-item"><a href="admin_parents_all.aspx">Add Parent</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Parent ID." CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <div class="input-group">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Email" CssClass="form-control" TextMode="Email"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="TextBox4" runat="server" placeholder="Phone" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-4 col-sm-6">
                                        <asp:Button ID="Button1" runat="server" Text="Search" CssClass="btn btn-sm btn-primary btn-block" OnClick="Button1_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-outline-primary btn-sm" style="font-size: x-small" OnClick="LinkButton1_Click">CSV</asp:LinkButton>      <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-outline-primary btn-sm" style="font-size: x-small" OnClick="LinkButton2_Click">PDF</asp:LinkButton>
                        <br />
                        <br />
                        <div class="table-responsive card">
                            <asp:GridView ID="GridView1" runat="server" DataKeyNames="PID" OnRowDataBound="OnRowDataBound" OnRowEditing="OnRowEditing" OnRowCancelingEdit="OnRowCancelingEdit" OnRowUpdating="OnRowUpdating" OnRowDeleting="OnRowDeleting" DeleteImageUrl="ch.fw.png" EmptyDataText="No records has been added." AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" AutoGenerateColumns="false" CssClass="table table-striped mb-0 " AllowPaging="true"
    OnPageIndexChanging="OnPageIndexChanging" PageSize="15" >
   <Columns>
                                                        <asp:BoundField DataField="PID" HeaderText="ParentID" SortExpression="PID" />
...
<%--          <asp:HyperLinkField HeaderText="Test Icon" DataNavigateUrlFields="PID" DataNavigateUrlFormatString="~/ClientInfo.aspx?PID={0}" DataTextField="clientComments" DataTextFormatString= "<img src='~/che.fw.png' alt='More Info'"/>"/>--%>
       <asp:HyperLinkField HeaderText="" DataNavigateUrlFields="PID" DataNavigateUrlFormatString="~/admin_parent_info.aspx?PID={0}" DataTextField="PID" DataTextFormatString= "<img src='che.fw.png' alt='More Info'/>"/>
        <asp:HyperLinkField HeaderText="" DataNavigateUrlFields="PID" DataNavigateUrlFormatString="~/admin_parent_child.aspx?PID={0}" DataTextField="PID" DataTextFormatString= "<img src='child.fw.png' alt='Child Info'/>"/>
