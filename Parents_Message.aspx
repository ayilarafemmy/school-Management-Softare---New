<%@ Page Title="" Language="C#" MasterPageFile="~/Parent_MasterPage.master" AutoEventWireup="true" CodeFile="Parents_Message.aspx.cs" Inherits="Parents_Message" %>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" id="Primary-tab" data-toggle="tab" href="#Primary">Messages</a></li>
<%--                        <li class="nav-item"><a class="nav-link" id="Social-tab" data-toggle="tab" href="#Social">Social</a></li>
        ...
        <asp:BoundField DataField="Message" HeaderText="Message"
         ...
         <asp:HyperLinkField HeaderText="View" DataNavigateUrlFields="RelationshipID"  DataNavigateUrlFormatString="~/Parents_MessageReader.aspx?RelationshipID={0} & SchoolR={0}" DataTextField="RelationshipID" DataTextFormatString= "<img src='kk.fw.png' alt='More Info'"/>
                            </Columns>
                        </asp:GridView>
                    </div>
